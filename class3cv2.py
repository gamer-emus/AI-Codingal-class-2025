...
center2_y = topleft2[1] + rect2_width //2 
...
cv2.putText(image_rgb, 'Region 1', (topleft1[0], topleft1[1] - 10), font, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Region 2', (topleft2[0], topleft2[1] - 10), font, 0.7, (255, 0, 255), 2, cv2.LINE_AA)
...
plt.title("Annotated images with regions, centers , And BI-directional Height arrow")
plt.axis("off")
plt.show()
